                        ...
                        <Popup>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div>
                                        <strong>Severity:</strong> {complaint.severity || "MEDIUM"}
                                    </div>

                                    <div>
                                        <strong>Trust Score:</strong> ⭐ {complaint.trustScore ? `${complaint.trustScore}/100` : "80/100"}
                                    </div>

                                    {complaint.challengeId && (
                                        <div>
                                            <strong>Cluster ID:</strong> 🏷️ {complaint.challengeId}
                                        </div>
                                    )}
