...
public class ProjectService {
    ...
    private final com.sih.sociosphere.student.StudentRepository studentRepository;
    private final com.sih.sociosphere.task.TaskRepository taskRepository;
    ...
    public ProjectService(
            ...
            com.sih.sociosphere.student.StudentRepository studentRepository,
            com.sih.sociosphere.task.TaskRepository taskRepository,
    ...
    public Project createProject(
        ...
        List<com.sih.sociosphere.student.Student> students = studentRepository.findByUniversityId(university.getId());
        if (!students.isEmpty()) {
            com.sih.sociosphere.student.Student leadStudent = students.get(0);
    ...
    private void createDefaultMilestones(Project project) {
        ...
        for (int i = 0; i < titles.size(); i++) {
            ...
            m.setStatus(i == 0 ? com.sih.sociosphere.common.enums.MilestoneStatus.IN_PROGRESS : com.sih.sociosphere.common.enums.MilestoneStatus.PENDING);
            m.setProgressPercentage(i == 0 ? 30 : 0);
            Milestone savedM = milestoneRepository.save(m);

            if (i == 0) {
                // Attach initial sprint tasks for student team
                com.sih.sociosphere.task.Task t1 = new com.sih.sociosphere.task.Task();
                ...
                t1.setPriority(com.sih.sociosphere.common.enums.Priority.HIGH);
                t1.setStatus(com.sih.sociosphere.common.enums.TaskStatus.IN_PROGRESS);
                t1.setDueDate(LocalDate.now().plusDays(7));
                taskRepository.save(t1);

                com.sih.sociosphere.task.Task t2 = new com.sih.sociosphere.task.Task();
                ...
                t2.setPriority(com.sih.sociosphere.common.enums.Priority.MEDIUM);
                t2.setStatus(com.sih.sociosphere.common.enums.TaskStatus.TODO);
                t2.setDueDate(LocalDate.now().plusDays(14));
                taskRepository.save(t2);

                com.sih.sociosphere.task.Task t3 = new com.sih.sociosphere.task.Task();
                ...
                t3.setPriority(com.sih.sociosphere.common.enums.Priority.LOW);
                t3.setStatus(com.sih.sociosphere.common.enums.TaskStatus.COMPLETED);
    ...
    public List<Project> getMyProjects(String email) {
        User user = userService.findByEmail(email);
        if (user != null && user.getRole() == com.sih.sociosphere.common.enums.UserRole.FACULTY) {
            ...
            return List.of();
        } else if (user != null && user.getRole() == com.sih.sociosphere.common.enums.UserRole.UNIVERSITY) {
            ...
            return List.of();
        } else if (user != null && user.getRole() == com.sih.sociosphere.common.enums.UserRole.STUDENT) {
            Optional<com.sih.sociosphere.student.Student> student = studentRepository.findByUserId(user.getId());
