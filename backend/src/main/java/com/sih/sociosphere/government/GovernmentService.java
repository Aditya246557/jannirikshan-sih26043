package com.sih.sociosphere.government;
...
import com.sih.sociosphere.complaint.ComplaintResponse;
import com.sih.sociosphere.complaint.ComplaintService;
...
public class GovernmentService {
    ...
    public Page<ComplaintResponse> getComplaints(String keyword, ComplaintStatus status, Priority priority, int page, int size) {
        return complaintService.filterChallenges(keyword, null, null, status, priority, PageRequest.of(page, size));
    }
