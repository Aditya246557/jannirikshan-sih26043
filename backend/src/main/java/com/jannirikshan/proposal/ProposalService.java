    ...
    public Proposal updateStatus(Long id, String statusStr, String remarks) {
        ...
        if (statusStr != null) {
            ...
            if ("APPROVED".equals(norm) || "ACCEPT".equals(norm) || "ACCEPTED".equals(norm)) {
                p.setStatus(com.jannirikshan.common.enums.ProposalStatus.APPROVED_BY_FACULTY);
            } else if ("REJECT".equals(norm) || "REJECTED".equals(norm)) {
                p.setStatus(com.jannirikshan.common.enums.ProposalStatus.REJECTED);
            } else {
                try {
                    p.setStatus(com.jannirikshan.common.enums.ProposalStatus.valueOf(norm));
